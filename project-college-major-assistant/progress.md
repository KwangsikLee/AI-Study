...
|------|------|--------|--------|-----------|------|
| 환경 설정 및 의존성 설치 | ⏳ 대기 | 0% | - | - | requirements.txt 생성 필요 |
| PDF 이미지 추출 모듈 연동 | ⏳ 대기 | 0% | - | - | a_my_rag_module/pdf_image.py |
| OCR 시스템 구현 | ⏳ 대기 | 0% | - | - | Tesseract/EasyOCR 선택 |
| 텍스트 전처리 파이프라인 | ⏳ 대기 | 0% | - | - | 한국어 처리 최적화 |
| 벡터 임베딩 시스템 | ⏳ 대기 | 0% | - | - | a_my_rag_module 기존 코드 활용 |
| 벡터 DB 구축 | ⏳ 대기 | 0% | - | - | ChromaDB/Pinecone 선택 |
| 기본 질의응답 시스템 | ⏳ 대기 | 0% | - | - | 단순 RAG 구현 |
